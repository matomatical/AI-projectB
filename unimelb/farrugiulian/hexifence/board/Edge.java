...
/** This Edge class represents a hexifence board edhe, separating up to 2
 *  cells within a game grid. It contains methods for accessing its information
 *  and that of its nearby cells
 * 
...
public class Edge extends Index {
	...
	/** Get the cell opposite from this cell across this edge (returning null 
	 *  if this edge is on the side of the board)
	 **/
