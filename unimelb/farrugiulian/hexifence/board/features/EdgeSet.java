 ...
 * capturability of neighbouring cells</li>
 * <li>capturing - edges that capture a cell and in doing so, also make a
 * neighbouring cell captureable</li>
 * <li>safe - edges that do not capture a cell, or make any of their
 * neighbouring cells captureable</li>
 * <li>sacrificing - edges that do not capture a cell but do make neighbouring
 * cells captureable (sacrificing those cells)</li>
 * </ul>
 * 
...
public class EdgeSet {
  ...
  /**
   * Set of edges that capture a cell with no consequences to the capturability
   * of neighbouring cells
   **/
  private QueueHashSet<Edge> free = new QueueHashSet<Edge>();

  /**
   * Set of edges that capture a cell and in doing so, also make a neighbouring
   * cell captureable
   **/
  private QueueHashSet<Edge> capturing = new QueueHashSet<Edge>();

  /**
   * Set of edges that do not capture a cell, or make any of their neighbouring
   * cells captureable
   **/
  ...
  /**
   * Create a new EdgeSet from a board. Randomises the order edges are inserted,
   * causing removal order to be effectively randomised (because removal order
   * is actually FIFO)
   * 
   * @param a
   *          board to use to make this EdgeSet
   **/
   ...
   * 
   * @param edge
   *          The edge that has been un-placed
   **/
