...
public class FeatureSet {
  ...
  /**
   * Collection of features on the board Kept up-to-date through
   * {@link Feature#consume Feature.consume()} (though the actual board is never
   * altered)
   **/
   ...
   * 
   * @return the array of Feature objects that this FeatureSet is storing (NOT a
   *         copy!)
   **/
   ...
   * 
   * @param piece
   *          the piece to look at the advantage as
   ...
   * 
   * @param piece
   *          the piece gaining these cells
   * @param score
   *          the number of cells to add to that piece's score
   **/
  ...
  /**
   * Get the frature containing this cell, or null if it's not contained in any
   * feature
   **/
   ...
   * 
   * @param board
   *          A <b>post-lockdown</b> board to analyse for features
   * @param piece
   *          We just need one piece to know which way to store the advantage
  ...
  /**
   * FeatureSet copy constructor Creates a copy of this featureset of limited
   * depth: its features are new but still reference cells from the same
   * underlying Board as the original
   * 
   * @param fs
   *          the FeatureSet to copy
   **/
   ...
   * 
   * @param cell
   *          cell to begin the classification search at
   * @param visited
   *          running HashSet of visited Cells to maintain
   **/
  ...
  /**
   * Helper function for classification, recursively constructs and classifies a
   * feature based on the nature of the cells it encounters
   * 
   * @param cell
   *          The next cell to recursively explore
   * @param parent
   *          The previous cell (to avoid branching backwards) - null at top
   *          level of recursion
   * @param visited
   *          HashSet of visited cells to maintain
   * @param feature
   *          Current Feature being constructed
   */
  private void explore(Cell cell, Cell parent, HashSet<Cell> visited,
      Feature feature) {
