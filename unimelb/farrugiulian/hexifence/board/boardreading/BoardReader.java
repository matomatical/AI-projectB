...
/** Class capable of reading and constructing a hexifence board form some
 *  input source
 *  
...
public interface BoardReader {
   ...
   * @param input may be a filename, or a description of a board, or whatever
   * @return a new board initialised to the state described by input
   * @throws InvalidInputException if something goes wrong reading the input
   */
