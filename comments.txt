 ...
 *                  Last Modified 18/05/16 by Matt Farrugia                  *
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
...
Other Creative Aspects: The Hexifence Visualisation Engine
    ...
    usage: java -jar <jarname>.jar
        jarname - 6_AgentFarrugiulian_AgentGreedy
                    watch our agent (blue) play against a greedy agent (red) on a dimension 6 board
                - 3_AgentFarrugiulian_AgentGreedy
                    watch our agent (blue) play against a greedy agent (red) on a dimension 3 board
                - 3_AgentFarrugiulian_AgentFarrugiulian
                    watch our agent (blue) play against itself (red) on a dimension 3 board
